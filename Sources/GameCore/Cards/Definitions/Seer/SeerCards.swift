...
public struct SpiritSight: CardDefinition {
    ...
    public static let name = LocalizedText("灵视", "Spirit Sight")
    ...
    public static let rulesText = LocalizedText(
        "「闭上双眼，第三只眼便会睁开。」预知 2。+1 疯狂。",
        "\"Close your eyes, and the third eye opens.\" Foresee 2. +1 Madness."
    )
...
public struct SpiritSightPlus: CardDefinition {
    ...
    public static let rulesText = LocalizedText(
        "「第三只眼洞察一切。」预知 3。+1 疯狂。",
        "\"The third eye sees all.\" Foresee 3. +1 Madness."
    )
...
public struct TruthWhisper: CardDefinition {
    ...
    public static let name = LocalizedText("真相低语", "Truth Whisper")
    public static let type: CardType = .attack
    public static let rarity: CardRarity = .common
    public static let cost = 1
    public static let rulesText = LocalizedText(
        "「真相是最锋利的刀刃。」造成 5 点伤害，预知 1。+1 疯狂。",
        "\"Truth is the sharpest blade.\" Deal 5 damage. Foresee 1. +1 Madness."
    )
...
public struct TruthWhisperPlus: CardDefinition {
    ...
    public static let cost = 1
    public static let rulesText = LocalizedText(
        "「真相刺穿一切伪装。」造成 7 点伤害，预知 2。+1 疯狂。",
        "\"Truth pierces every disguise.\" Deal 7 damage. Foresee 2. +1 Madness."
    )
    public static let upgradedId: CardID? = nil
...
public struct Meditation: CardDefinition {
    ...
    public static let name = LocalizedText("冥想", "Meditation")
    public static let type: CardType = .skill
    public static let rarity: CardRarity = .common
    public static let cost = 1
    public static let rulesText = LocalizedText(
        "「在疯狂的世界里，片刻宁静弥足珍贵。」获得 4 点格挡，清除 2 疯狂。",
        "\"In a mad world, a moment of calm is precious.\" Gain 4 Block, remove 2 Madness."
    )
...
public struct MeditationPlus: CardDefinition {
    ...
    public static let cost = 1
    public static let rulesText = LocalizedText(
        "「深度冥想带来深度宁静。」获得 6 点格挡，清除 3 疯狂。",
        "\"Deep meditation brings deep calm.\" Gain 6 Block, remove 3 Madness."
    )
    public static let upgradedId: CardID? = nil
...
public struct SanityBurn: CardDefinition {
    ...
    public static let name = LocalizedText("理智燃烧", "Sanity Burn")
    public static let type: CardType = .skill
    public static let rarity: CardRarity = .common
    public static let cost = 1
    public static let rulesText = LocalizedText(
        "「燃烧理智，换取力量——这是每个占卜师都会面临的诱惑。」获得 2 点力量。+3 疯狂。",
        "\"Burn sanity for power—every seer faces this temptation.\" Gain 2 Strength. +3 Madness."
    )
...
public struct SanityBurnPlus: CardDefinition {
    ...
    public static let cost = 1
    public static let rulesText = LocalizedText(
        "「理智的火焰燃烧得更加猛烈。」获得 3 点力量。+3 疯狂。",
        "\"The flames of sanity burn fiercer.\" Gain 3 Strength. +3 Madness."
    )
    public static let upgradedId: CardID? = nil
...
public struct FateRewrite: CardDefinition {
    ...
    public static let name = LocalizedText("命运改写", "Fate Rewrite")
    public static let type: CardType = .skill
    public static let rarity: CardRarity = .uncommon
    public static let cost = 1
    public static let targeting: CardTargeting = .singleEnemy
    public static let rulesText = LocalizedText(
        "「命运的丝线在我指尖缠绕——我可以剪断，也可以重编。」改写：目标敌人意图变为「防御」。+2 疯狂。",
        "\"Fate's threads twist at my fingertips—I can cut or reweave them.\" Rewrite: target enemy's intent becomes \"Defend\". +2 Madness."
    )
...
public struct FateRewritePlus: CardDefinition {
    ...
    public static let cost = 1
    public static let rulesText = LocalizedText(
        "「命运在我手中重塑。」改写：所有敌人意图变为「防御」。+2 疯狂。",
        "\"Fate is reshaped in my hands.\" Rewrite: all enemies' intents become \"Defend\". +2 Madness."
    )
    public static let upgradedId: CardID? = nil
...
public struct TimeShard: CardDefinition {
    ...
    public static let name = LocalizedText("时间碎片", "Time Shard")
    public static let type: CardType = .skill
    public static let rarity: CardRarity = .uncommon
    public static let cost = 1
    public static let rulesText = LocalizedText(
        "「过去并未消逝，只是被遗忘。」回溯 1，抽 1 张牌。+1 疯狂。",
        "\"The past never vanished, only forgotten.\" Rewind 1, draw 1 card. +1 Madness."
    )
...
public struct TimeShardPlus: CardDefinition {
    ...
    public static let cost = 1
    public static let rulesText = LocalizedText(
        "「时间的碎片在指尖重组。」回溯 2，抽 1 张牌。+1 疯狂。",
        "\"Fragments of time reassemble at my fingertips.\" Rewind 2, draw 1 card. +1 Madness."
    )
    public static let upgradedId: CardID? = nil
...
public struct PurificationRitual: CardDefinition {
    ...
    public static let name = LocalizedText("净化仪式", "Purification Ritual")
    public static let type: CardType = .skill
    public static let rarity: CardRarity = .uncommon
    public static let cost = 2
    public static let rulesText = LocalizedText(
        "「遗忘是一种慈悲——也是一种代价。」清除所有疯狂，随机弃置 1 张手牌。",
        "\"Forgetting is mercy—and a price.\" Remove all Madness, discard 1 random card."
    )
...
public struct PurificationRitualPlus: CardDefinition {
    ...
    public static let rulesText = LocalizedText(
        "「遗忘不再需要代价。」清除所有疯狂。",
        "\"Forgetting no longer demands a price.\" Remove all Madness."
    )
    public static let upgradedId: CardID? = nil
...
public struct ProphecyEcho: CardDefinition {
    ...
    public static let name = LocalizedText("预言回响", "Prophecy Echo")
    public static let type: CardType = .attack
    public static let rarity: CardRarity = .uncommon
    public static let cost = 1
    public static let rulesText = LocalizedText(
        "「每一次窥探，都在时间线上留下裂痕。」造成 3 伤害 × 本回合预知次数。+1 疯狂。",
        "\"Every glimpse leaves a crack in the timeline.\" Deal 3 damage × times you Foresee this turn. +1 Madness."
    )
...
public struct ProphecyEchoPlus: CardDefinition {
    ...
    public static let cost = 1
    public static let rulesText = LocalizedText(
        "「裂痕回响成雷鸣。」造成 4 伤害 × 本回合预知次数。+1 疯狂。",
        "\"Cracks echo into thunder.\" Deal 4 damage × times you Foresee this turn. +1 Madness."
    )
    public static let upgradedId: CardID? = nil
...
public struct AbyssalGaze: CardDefinition {
    ...
    public static let name = LocalizedText("深渊凝视", "Abyssal Gaze")
    public static let type: CardType = .attack
    public static let rarity: CardRarity = .rare
    public static let cost = 2
    public static let rulesText = LocalizedText(
        "「当你凝视深渊时，深渊也在凝视你。」对目标造成 18 点伤害。",
        "\"When you gaze into the abyss, it gazes back.\" Deal 18 damage to a target."
    )
...
public struct AbyssalGazePlus: CardDefinition {
    ...
    public static let cost = 2
    public static let rulesText = LocalizedText(
        "「深渊的回望更为清晰。」对目标造成 24 点伤害。",
        "\"The abyss's gaze grows clearer.\" Deal 24 damage to a target."
    )
    public static let upgradedId: CardID? = nil
...
public struct SequenceResonanceCard: CardDefinition {
    ...
    public static let rulesText = LocalizedText(
        "「序列之间存在共鸣——占卜师能听见它们的低语。」本场战斗中，每次预知后获得 1 格挡。+1 疯狂。",
        "\"Sequences resonate—seers can hear their whispers.\" This battle, gain 1 Block after each Foresee. +1 Madness."
    )
...
public struct SequenceResonanceCardPlus: CardDefinition {
    ...
    public static let cost = 3
    public static let rulesText = LocalizedText(
        "「共鸣化作屏障。」本场战斗中，每次预知后获得 2 格挡。+1 疯狂。",
        "\"Resonance becomes a barrier.\" This battle, gain 2 Block after each Foresee. +1 Madness."
    )
    public static let upgradedId: CardID? = nil
