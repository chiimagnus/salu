...
public struct JawWorm: EnemyDefinition {
    ...
    public static let name = LocalizedText("咀嚼者", "Jaw Worm")
    ...
    public static func chooseMove(selfIndex: Int, snapshot: BattleSnapshot, rng: inout SeededRNG) -> EnemyMove {
            ...
            if roll < 75 {
                return EnemyMove(
                    intent: EnemyIntentDisplay(
                        icon: "⚔️",
                        text: LocalizedText("攻击 11", "Attack 11"),
                        previewDamage: 11
                    ),
                ...
                return EnemyMove(
                    intent: EnemyIntentDisplay(icon: "💪", text: LocalizedText("力量 +3", "Strength +3")),
        ...
        if roll < 45 {
            return EnemyMove(
                intent: EnemyIntentDisplay(icon: "⚔️", text: LocalizedText("攻击 11", "Attack 11"), previewDamage: 11),
                effects: [.dealDamage(source: .enemy(index: selfIndex), target: .player, base: 11)]
            )
        } else if roll < 75 {
            return EnemyMove(
            ...
            return EnemyMove(
                intent: EnemyIntentDisplay(icon: "⚔️", text: LocalizedText("猛扑 7", "Lunge 7"), previewDamage: 7),
...
public struct Cultist: EnemyDefinition {
    ...
    public static let name = LocalizedText("虔信者", "Cultist")
    ...
    public static func chooseMove(selfIndex: Int, snapshot: BattleSnapshot, rng: inout SeededRNG) -> EnemyMove {
        ...
        // 后续回合攻击
        return EnemyMove(
            intent: EnemyIntentDisplay(icon: "⚔️", text: LocalizedText("攻击 6", "Attack 6"), previewDamage: 6),
...
public struct LouseGreen: EnemyDefinition {
    ...
    public static let name = LocalizedText("翠鳞虫", "Green Louse")
    ...
    public static func chooseMove(selfIndex: Int, snapshot: BattleSnapshot, rng: inout SeededRNG) -> EnemyMove {
        ...
        if roll < 75 {
            ...
            return EnemyMove(
                intent: EnemyIntentDisplay(icon: "💪", text: LocalizedText("卷曲 +3", "Curl Up +3")),
                effects: [.applyStatus(target: .enemy(index: selfIndex), statusId: "strength", stacks: 3)]
            )
        }
    }
...
public struct LouseRed: EnemyDefinition {
    ...
    public static let name = LocalizedText("血眼虫", "Red Louse")
...
public struct SporeBeast: EnemyDefinition {
    ...
    public static let name = LocalizedText("腐菌体", "Spore Beast")
    ...
    public static func chooseMove(selfIndex: Int, snapshot: BattleSnapshot, rng: inout SeededRNG) -> EnemyMove {
        ...
        if snapshot.turn == 1 {
            return EnemyMove(
                intent: EnemyIntentDisplay(
                    icon: "☁️",
                    text: LocalizedText("孢子喷射 5 + 脆弱 1", "Spore Spray 5 + Frail 1"),
                    previewDamage: 5
                ),
                effects: [
        ...
        if roll < 65 {
            ...
            return EnemyMove(
                intent: EnemyIntentDisplay(icon: "🛡️", text: LocalizedText("孢子护甲：格挡 10", "Spore Armor: Block 10")),
                effects: [
...
public struct SlimeSmallAcid: EnemyDefinition {
    ...
    public static let name = LocalizedText("溶蚀幼崽", "Acid Slime")
    ...
    public static func chooseMove(selfIndex: Int, snapshot: BattleSnapshot, rng: inout SeededRNG) -> EnemyMove {
        ...
        if roll < 70 {
            return EnemyMove(
                intent: EnemyIntentDisplay(icon: "⚔️", text: LocalizedText("攻击 7", "Attack 7"), previewDamage: 7),
                effects: [
            ...
            return EnemyMove(
                intent: EnemyIntentDisplay(
                    icon: "⚔️💀",
                    text: LocalizedText("涂抹 4 + 虚弱 1", "Lick 4 + Weak 1"),
                    previewDamage: 4
                ),
                effects: [
