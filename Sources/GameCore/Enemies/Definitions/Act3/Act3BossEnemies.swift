...
public struct SequenceProgenitor: EnemyDefinition {
    ...
    public static func chooseMove(selfIndex: Int, snapshot: BattleSnapshot, rng: inout SeededRNG) -> EnemyMove {
        ...
        case 0:
            // 回合 1：命运宣告 - 全面削弱 + 力量成长
            return EnemyMove(
                intent: EnemyIntentDisplay(icon: "👁️", text: "命运宣告：易伤 2 + 虚弱 2 + 力量 +1"),
                effects: [
        ...
        case 1:
            // 回合 2：触手乱舞 - 多段攻击
            return EnemyMove(
                intent: EnemyIntentDisplay(icon: "🦑", text: "触手乱舞 10×3", previewDamage: 30),
                effects: [
        ...
        case 2:
            // 回合 3：虚无凝视 - 重击 + 中毒
            return EnemyMove(
                intent: EnemyIntentDisplay(icon: "💀", text: "虚无凝视 25 + 中毒 3", previewDamage: 25),
                effects: [
        ...
        default:
            // 回合 4：循环终结 - 超强单击 + 自我回复
            return EnemyMove(
                intent: EnemyIntentDisplay(icon: "🌀", text: "循环终结 35 + 回复 10", previewDamage: 35),
                effects: [
