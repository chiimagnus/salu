...
enum Screens {
    ...
    static func showSettingsMenu(historyService: HistoryService, showLog: Bool, language: GameLanguage) {
        SettingsScreen.show(historyService: historyService, showLog: showLog, language: language)
    }
